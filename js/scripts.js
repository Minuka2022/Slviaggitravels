$(document).ready(function () {
  ...
  $(window).on("resize", function () {
    ...
    if (iPad) {
      ...
      if ($(".main_slider").length) {
        ...
        $(".ipad .tour-slider .tour_item:first-child").css(
          "margin-left",
          margin + "px"
        );
        $(".ipad .tour-slider .tour_item:last-child").css(
          "margin-right",
          margin + "px"
        );
        ...
        $(".ipad .stries_slider .story_item:first-child").css(
          "margin-left",
          margin + "px"
        );
        $(".ipad .stries_slider .story_item:last-child").css(
          "margin-right",
          margin + "px"
        );
      }
      ...
      if ($(".tour_page_head").length) {
        ...
        $(".ipad .tour_page_head .bottom-info").css(
          "margin-left",
          margin + "px"
        );
        $(".ipad .tour_page_head .slider .slide:first-child").css(
          "margin-left",
          margin + "px"
        );
        $(".ipad .tour_page_head .slider .slide:last-child").css(
          "margin-right",
          margin + "px"
        );
      }
      ...
      if ($(".team_item").length) {
        ...
        $(".ipad .about-us-page .team_item:first-child").css(
          "margin-left",
          margin + "px"
        );
        $(".ipad .about-us-page .team_item:last-child").css(
          "margin-right",
          margin + "px"
        );
      }
  ...
  if ($(".page_404").length) {
    ...
    var background =
      "radial-gradient(circle at %%, rgba(255,255,255, .8) 0%, rgba(0,0,0,0.85) 25%, rgba(0,0,0,0.85) 100%)";
