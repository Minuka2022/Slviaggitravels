document.addEventListener("DOMContentLoaded", function () {
  ...
  submitButton.addEventListener("click", function () {
    ...
    const originalDay1 = document
      .querySelector('[name="day"]')
      .textContent.trim();
    const originalMonth1 = document
      .querySelector('[name="month"]')
      .textContent.trim();
    const originalYear1 = document
      .querySelector('[name="year"]')
      .textContent.trim();

    const adultsValue = document.querySelector('input[name="adults"]').value;
    const childrenValue = document.querySelector(
      'input[name="children"]'
    ).value;

    // Auto-fill the text into other divs
    document.querySelector('[name="auto-fill-day"]').textContent = originalDay;
    document.querySelector('[name="auto-fill-month"]').textContent =
      originalMonth;
    document.querySelector('[name="auto-fill-year"]').textContent =
      originalYear;

    document.querySelector('[name="auto-fill-day1"]').textContent =
      originalDay1;
    document.querySelector('[name="auto-fill-month1"]').textContent =
      originalMonth1;
    document.querySelector('[name="auto-fill-year1"]').textContent =
      originalYear1;

    document.querySelector('span[name="auto-fill-adults"]').textContent =
      adultsValue;
    document.querySelector('span[name="auto-fill-children"]').textContent =
      childrenValue;
    // change
  });
});
...
src =
  ...
  (function () {
    emailjs.init("5xxA_yB93Ds11__rX");
  })();
...
document.addEventListener("DOMContentLoaded", function () {
  document.querySelector(".js-submit").addEventListener("click", function () {
    ...
    emailjs.init("5xxA_yB93Ds11__rX"); // Replace with your User ID

    // Prepare the email template parameters for your email
    var templateParamsForYou = {
      to_name: "Bhagya", // Replace with your name or the desired recipient name
    ...
    emailjs
      .send("service_2wjbxze", "template_an2nb5p", templateParamsForYou)
    ...
    emailjs
      .send("service_2wjbxze", "template_hl2ce4p", templateParamsForCustomer)
      .then(function (response) {
